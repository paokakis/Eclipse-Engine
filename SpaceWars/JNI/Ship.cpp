...
void Ship::initialize() {
	...
	b2Vec2 position(mGraphicsManager.getRenderWidth() * INITAL_X / PHYSICS_SCALE,
	...
	if (mLives >= 0) 
	{
		if (((PhysicsCollision*)mBody->GetUserData())->collide) 
		{
			...
			if (mLives < 0) 
			{
				...
				mGraphics->setAnimation(SHIP_DESTROY_FRAME_1, SHIP_DESTROY_FRAME_COUNT, SHIP_DESTROY_ANIM_SPEED, false);
